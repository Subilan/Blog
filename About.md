...
在 MBTI 中，我的人格类型是 INFP-T（即2019 年和 2021 年测试结果）。我对于大部分非娱乐性质的心理学测试的观点是：既不能过于重视，也不能过于轻视。

> *虽然 MBTI 类似于一些心理学理论，但它被批评为伪科学，并没有在有关学术研究领域获广泛承认。 该指标显示出重大的科学（心理统计学）缺陷，主要包括：
> - 测验效度不理想（即没有测量到其测量目标，没有预测能力或没有可以概括的项目）；
> - 信度不理想（同一个人在不同情境下获得不同结果）；
> - 测量不独立的类别（已注意到一些二分特征相互关联）；
> - 不全面（由于缺少神经质）*

虽然 MBTI 并不被科学承认，但我认为它至少将具有相同心理基本特征的人联系到了一起。MBTI 的结果并不能被当作是自己身上的一个标签，或者决定自己对自己的定位，但它确实对自我认识有所帮助。它没有肯定任何人有心理疾病，只是利用主观经验推测出了你的性格类型（是内向还是外向，是理性还是感性，等等），可能拥有的心境，也有些符合，有些不符合。批判性地接受就好。
