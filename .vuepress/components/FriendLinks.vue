<template>
	<div class="links-container">
		...
		>
			...
			<div
				:style="link.light === true ? 'color: white' : null"
				class="link-content"
			>
		...
		return {
			links: [
				...
				},
				{
					...
					avatar: "https://img.leviatan.cn/images/2021/11/17/WindSpiritIT-LOGO-2567b90eeb16a21f539.png",
				...
				},
				{
					...
					background:
						"https://www.littleqiu.net/wp-content/uploads/2018/01/ChulillaSpain_ZH-CN10170248808_1920x1080.jpg",
					light: true,
				},
				{
					name: "Bottle 小站",
				...
				},
				{
					...
					background_type: "image",
					background:
						"https://i.loli.net/2020/06/07/Sa7dWDtVMivUnoQ.jpg",
					light: true,
				},
				{
					name: "Socular 的博客",
